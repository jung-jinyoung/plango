...
//   - 월간 목표 baseline(60h) 초과(75.83h, 약 26%) — 목업 사이드바 45%와는 별개 스냅샷으로 유지
...
const monthlyGoalThesis = {
  ...
  // 잠금값(생성 후 변경 금지, CLAUDE.md 4절) — 아래 achieved 4개 실측 합(57.83h)
  // +active 2개(18h)=monthlyCurrentHours(75.83h)가 이보다 커야 "범위 초과" 경고가
  // 재현된다. 60h는 achieved 실측 합 근처로 잡은 "초기 추정" — 나중에 achieved가
  // 쌓이며 조금 넘어선 정도의 자연스러운 폭(75.83/60≈26% 초과)이 되도록 골랐다.
  baselineHours: 60,
