...
export function buildSeedReports() {
  ...
  weeks.forEach(({ offset, completionRate, breakdown }) => {
    ...
    reports.push({
      ...
      completionRate,
      categoryBreakdown: [
        { color: 'rose', label: '로즈', completed: roseDone, total: roseTotal },
        { color: 'blue', label: '블루', completed: blueDone, total: blueTotal },
        { color: 'green', label: '그린', completed: greenDone, total: greenTotal },
        { color: 'lavender', label: '라벤더', completed: lavenderDone, total: lavenderTotal },
      ],
      weeklyBreakdown: [],
  ...
  months.forEach(({ offset, completionRate, weekly }) => {
    ...
    reports.push({
      ...
      completionRate,
      categoryBreakdown: [
        { color: 'rose', label: '로즈', completed: 18, total: 26 },
        { color: 'blue', label: '블루', completed: 12, total: 20 },
        { color: 'green', label: '그린', completed: 14, total: 18 },
        { color: 'lavender', label: '라벤더', completed: 8, total: 15 },
      ],
